<?php 
$connect = mysqli_connect("localhost", "root", "", "1851061430");
$query = "SELECT * FROM sinhvien ORDER BY name ASC";
...
<html>
 ...
 <body>
   <h3 id="tieude">Search Employee Data</h3>
  <br /><br />
